...
export function WaveCard({
  ...
  return (
    <>
      ...
      <div
        className={`wc-${uid} relative w-full max-w-[240px] mx-auto aspect-[240/330] rounded-2xl overflow-hidden bg-transparent ${className}`}
        style={{
      ...
      >
        {/* Background */}
        <div className="absolute inset-0 bg-[#0f1c24]" />
        ...
        {/* Info overlay */}
        <div className="absolute inset-x-0 top-[5.6em] text-center text-white font-semibold text-lg sm:text-xl z-10">
          {/* Icon */}
          <div
          ...
          {/* Subtitle */}
          <div
            className={`text-xs sm:text-sm font-light mt-3 sm:mt-4 lowercase opacity-80 ${subtitleClass}`}
          >
            {subtitle}
          </div>
        </div>
